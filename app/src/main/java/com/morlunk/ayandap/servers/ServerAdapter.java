...
package com.morlunk.ayandap.servers;
...
public abstract class ServerAdapter<E extends Server> extends ArrayAdapter<E> {
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        TextView nameText = view.findViewById(R.id.server_row_name);
        TextView userText = view.findViewById(R.id.server_row_user);
        TextView addressText = view.findViewById(R.id.server_row_address);
        ...
        final ImageView moreButton = view.findViewById(R.id.server_row_more);
        if(moreButton != null) {
        ...
        TextView serverVersionText = view.findViewById(R.id.server_row_version_status);
        TextView serverLatencyText = view.findViewById(R.id.server_row_latency);
        TextView serverUsersText = view.findViewById(R.id.server_row_usercount);
        ProgressBar serverInfoProgressBar = view.findViewById(R.id.server_row_ping_progress);
