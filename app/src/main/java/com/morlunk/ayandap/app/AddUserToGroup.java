...
public class AddUserToGroup extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    SharedPreferences sharedPreferences = AddUserToGroup.this.getSharedPreferences("MyPref", Context.MODE_PRIVATE);
    choosen.clear();
    userId = sharedPreferences.getString(AddUserToGroup.this.getString(R.string.PREF_TAG_userid), "0");
    ...
    mAdapter = new InviteUserToGroupAdapter(AddUserToGroup.this, choosen);
    ...
    continue_button = findViewById(R.id.invite_to_group);
...
//        Intent intent = new Intent(AddUserToGroup.this,FinishUpGroupActivity.class);
//        intent.putExtra("toUsers",toUsers);
//        startActivity(intent);
//        finish();
        nameValuePairs = new ArrayList<NameValuePair>();
        nameValuePairs.add(new BasicNameValuePair("func", "inviteToGroup"));
        nameValuePairs.add(new BasicNameValuePair("fromUser", userId));
        ...
        new ServerFetchAsync(nameValuePairs, new OnTaskCompletedListener() {
          ...
          public void onTaskCompleted(JSONObject jsonObject) {
            ...
            try {
              if (jsonObject.getString("users").equals("INVITED")) {
                  Toast.makeText(AddUserToGroup.this, "کاربران مورد نظر به گروه دعوت شدند", Toast.LENGTH_LONG).show();
                  finish();
              }
              else
              {
                Toast.makeText(AddUserToGroup.this, "مشکلی پیش آمده است ، دوباره تلاش کنید", Toast.LENGTH_LONG).show();
              }
            } catch (Exception e) {
              e.printStackTrace();
            }
              ...
              if(old.equals(newText)) {
                ...
                new ServerFetchAsync(nameValuePairs, new OnTaskCompletedListener() {
                  ...
                  public void onTaskCompleted(JSONObject jsonObject) {
                    ...
                    final SearchListAdapter adapter = new SearchListAdapter(AddUserToGroup.this, listValues);
