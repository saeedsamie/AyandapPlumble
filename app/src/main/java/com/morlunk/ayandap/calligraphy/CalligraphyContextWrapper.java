package com.morlunk.ayandap.calligraphy;
...
public class CalligraphyContextWrapper extends ContextWrapper {
    ...
    /**
     * Uses the default configuration from { uk.co.chrisjenx.calligraphy.CalligraphyConfig}
     *
     * Remember if you are defining default in the
     * { uk.co.chrisjenx.calligraphy.CalligraphyConfig} make sure this is initialised before
     ...
     * { uk.co.chrisjenx.calligraphy.CalligraphyConfig.Builder#disablePrivateFactoryInjection()}
     ...
     * and ignore the one set in { uk.co.chrisjenx.calligraphy.CalligraphyConfig}.
     *
     * Remember if you are defining default in the
     * { uk.co.chrisjenx.calligraphy.CalligraphyConfig} make sure this is initialised before
     * the activity is created.
