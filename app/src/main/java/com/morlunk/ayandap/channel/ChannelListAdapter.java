...
import com.morlunk.ayandap.db.PlumbleDatabase;
import com.morlunk.ayandap.drawable.CircleDrawable;
import com.morlunk.ayandap.drawable.FlipDrawable;
import com.morlunk.ayandap.service.PlumbleService;
import com.morlunk.ayandap.util.TalkingIndicatorView;
...
//        public ImageView mUserAvatar;
        ...
        public UserViewHolder(View itemView) {
            super(itemView);
            mUserHolder = itemView.findViewById(R.id.user_row_title);
            mUserTalkHighlight = itemView.findViewById(R.id.user_row_talk_highlight);
            mUserName = itemView.findViewById(R.id.user_row_name);
            mMoreButton = itemView.findViewById(R.id.user_row_more);
            mTalkingIndicator = itemView.findViewById(R.id.user_row_talk_indicator);
        }
    }
    ...
    private static class ChannelViewHolder extends RecyclerView.ViewHolder {
        ...
        public ChannelViewHolder(View itemView) {
            super(itemView);
            mChannelHolder = itemView.findViewById(R.id.channel_row_title);
            mChannelExpandToggle = itemView.findViewById(R.id.channel_row_expand);
            mChannelName = itemView.findViewById(R.id.channel_row_name);
            mChannelUserCount = itemView.findViewById(R.id.channel_row_count);
            mJoinButton = itemView.findViewById(R.id.channel_row_join);
            mMoreButton = itemView.findViewById(R.id.channel_row_more);
        }
    }
